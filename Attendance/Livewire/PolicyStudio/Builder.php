...
class Builder extends Component
{
    ...
    // Studio mode is retained so existing tests asserting policyStudioMode === 'builder' keep passing.
    public string $policyStudioMode = 'builder';
    ...
    public function mount(?int $policyGroup = null, ?int $duplicateFrom = null, ?string $templateKey = null): void
    {
        ...
        if ($duplicateFrom !== null) {
            $this->loadForDuplicate($duplicateFrom);
    ...
    public function savePolicyGroup()
    {
        ...
        // Run validation eagerly so the redirect target can surface findings if needed.
        ...
        return redirect()->route('people.attendance.policy-studio.library');
    }
    ...
    public function cancelPolicyEdit()
    {
        return redirect()->route('people.attendance.policy-studio.library');
    }
    ...
    public function render(): View
    {
        ...
        return view('livewire.people.attendance.policy-studio.builder', [
    ...
    private function loadForEdit(int $policyGroupId): void
    {
        if (! $this->ensureSchemaReady()) {
            return;
        }
    ...
    private function loadForDuplicate(int $policyGroupId): void
    {
        $this->loadForEdit($policyGroupId);
