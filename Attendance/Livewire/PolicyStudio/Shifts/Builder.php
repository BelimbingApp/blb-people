...
class Builder extends Component
{
    ...
    public function mount(?int $shift = null, ?int $duplicateFrom = null, ?string $templateKey = null): void
    {
    ...
    public function saveShiftTemplate()
    {
        ...
        return redirect()->route('people.attendance.shift-library');
    }
    ...
    public function cancelShiftEdit()
    {
        return redirect()->route('people.attendance.shift-library');
    }
    ...
    private function loadForEdit(int $shiftTemplateId): void
    {
        if (! $this->ensureSchemaReady()) {
            return;
        }
    ...
    private function loadForDuplicate(int $shiftTemplateId): void
    {
        $this->loadForEdit($shiftTemplateId);
