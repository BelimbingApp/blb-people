...
namespace App\Domains\People\Skills\Database\Seeders;
...
use App\Domains\People\Skills\Workflow\RequirementProfileTransitionAction;
use App\Domains\People\Skills\Workflow\RequirementProfileTransitionGuard;
...
final class RequirementProfileWorkflowSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $edges = [
            ['draft', 'pending_hod_review', 'Submit for HOD review', 'people.skill-requirement.submit'],
            ['pending_hod_review', 'draft', 'Return to draft', 'people.skill-requirement.hod-approve'],
            ['pending_hod_review', 'pending_hr_review', 'Approve technical review', 'people.skill-requirement.hod-approve'],
            ['pending_hr_review', 'draft', 'Return to draft', 'people.skill-requirement.approve'],
            ['pending_hr_review', 'approved', 'Approve governance review', 'people.skill-requirement.approve'],
            ['approved', 'draft', 'Reopen draft', 'people.skill-requirement.approve'],
            ['approved', 'published', 'Publish', 'people.skill-requirement-publication.approve'],
            ['published', 'retired', 'Retire', 'people.skill-requirement-retirement.approve'],
        ];
