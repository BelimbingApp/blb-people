...
use App\Domains\People\Skills\Events\RequirementProfilePublished;
use App\Domains\People\Skills\Events\RequirementProfileRetired;
use App\Domains\People\Skills\Exceptions\InvalidRequirementProfileException;
use App\Domains\People\Skills\Exceptions\RequirementProfileNotFoundException;
...
use App\Domains\People\Skills\Models\RequirementProfileWorkflowParticipant;
...
class RequirementProfileStore
{
    ...
    private function transitionCapability(
        ...
        return match ([$from, $to]) {
            [RequirementProfileStatus::Draft, RequirementProfileStatus::PendingHodReview] => 'people.skill-requirement.submit',
            [RequirementProfileStatus::PendingHodReview, RequirementProfileStatus::Draft],
            [RequirementProfileStatus::PendingHodReview, RequirementProfileStatus::PendingHrReview] => 'people.skill-requirement.hod-approve',
            ...
            [RequirementProfileStatus::Approved, RequirementProfileStatus::Draft] => 'people.skill-requirement.approve',
            [RequirementProfileStatus::Approved, RequirementProfileStatus::Published] => 'people.skill-requirement-publication.approve',
            [RequirementProfileStatus::Published, RequirementProfileStatus::Retired] => 'people.skill-requirement-retirement.approve',
            [RequirementProfileStatus::PendingHodReview, RequirementProfileStatus::Published],
            [RequirementProfileStatus::PendingHrReview, RequirementProfileStatus::Published] => 'people.skill-requirement-publication.approve',
    ...
    private function assertSelectors(int $tenantId, int $companyEntityId, array $selectors): void
    {
        ...
        foreach ($selectors as $selector) {
            ...
            $type = $selector->selectorType === SelectorType::Department
            ...
            if (app(WorkforceSubjects::class)->resolve(
                ...
                $companyEntityId,
                $type,
                $selector->selectorEntityId,
            ) === null) {
                throw new InvalidRequirementProfileException(
                    "Selector entity [{$selector->selectorEntityId}] does not belong to this company.",
                );
            }
        }
    }
