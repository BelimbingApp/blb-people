...
function catalogPageViewer(int $companyId): User
{
    ...
    PrincipalCapability::query()->create([
        ...
        'capability_key' => 'people.skill.catalog.view',
        'is_allowed' => true,
    ]);
    ...
    PrincipalCapability::query()->create([
        ...
        'principal_type' => PrincipalType::USER->value,
        'principal_id' => $viewer->id,
        'capability_key' => 'people.skill.hod.view',
        'is_allowed' => true,
    ]);
...
test('a single-company tenant with a tenant-scoped provider stays visible, then fails closed when a second company appears', function (): void {
    ...
    foreach (['people.skill.catalog.view', 'people.skill.catalog.manage', 'people.skill.hr.view'] as $capability) {
        PrincipalCapability::query()->create([
